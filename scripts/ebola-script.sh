...
cd data
python3 ../scripts/OMA-orthology-search-pandas.py hpidb2/ppi-human-ebola.csv	oma_orthologs/orthologs_human_myotis.csv # outputs updated hpidb2-human-ebola-ortholog.csv that contains additional column "batOrthologExists"
cd ..
