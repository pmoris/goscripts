...
class goTerm:
    ...
    __slots__ = ('id', 'name', 'altid', 'namespace', 'children', 'parents',
                 'recursive_children', 'recursive_parents', 'level')
...
def buildGOtree(GOdict):
    ...
    # Process each GO term in the GO dictionary to a) recursively find parents and b) label immediate children.
    for GOid, GOobj in GOdict.items():
        ...
        # set children attribute of GO ids
    ...
    # After all parents have been found, for each GO ID, add it as a child for all of its parents
