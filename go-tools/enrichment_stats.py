...
def enrichmentAnalysis(GOdict, gafDict, gafSubset,
    ...
    First, all GO term id's associated with the genes in the subset of interest,
    ...
    In the end, a dictionary containing the tested GO id's mapped to p-values is returned.
    ...
    # 1) get all GO term id's from gene association dictionary of subset of interest
    # 2) retrieve all parents for these terms
